...
RowLayout {
    ...
    readonly property int originalValue: Util.hasKey(original, targetPath) ? Util.getJsonValue(original, targetPath) : 0
    readonly property int modifiedValue: Util.hasKey(modified, targetPath) ? Util.getJsonValue(modified, targetPath) : 0
    ...
    ToolButton {
        ...
        onClicked: {
            ...
            SaveGameManager.setValue(fileIndex, targetPath, quantity)
